                    ...
                    <div class="col-lg-4">
						<ol class="success">
                              <h2>
					   				 ...
					   				 <img class="img-thumbnail" src="http://placehold.it/100x120" alt="" style="float:left; margin-right:20px; margin-bottom:20px"> 
                        ...
                        <form role=" ">
                            ...
                            <div class="form-group"> 
                                <input type="text" name="username" id="username" placeholder="Artilife" class="form-control" >
                             </div>
