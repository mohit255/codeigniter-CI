...
<div class="login-form-container" id="output">
   ...
   <div class="row">
    ...
    <form name="form1" id="time_deposit_form" method="POST" action="<?php echo base_url().'time-deposit-confirm' ?>">
        <br>
        <p class="down">(₱<?php echo $time_rate['ammount_range']; ?>)</p>
        <div style="text-align: center;">

        <?php
         $time1 = explode(",", $time_rate["time"]);
         $rate1 = explode(",", $time_rate["rate"]);
        ?>
        ...
        <div style="text-align: center;">
        <?php
         $time2 = explode(",", $time_rate2["time"]);
         $rate2 = explode(",", $time_rate2["rate"]);
        ?>
        <p class="down">(₱<?php echo $time_rate2['ammount_range']; ?>)</p>
