...
<head>
 ...
 <link href="https://louerma.com/crop/croppie.css" rel="stylesheet">
...
<script id="ze-snippet" src="https://static.zdassets.com/ekr/snippet.js?key=fb7fd5ed-4787-42a3-ae97-9c6691e590ac"> </script>
        ...
        <div class="clearfix">
            ...
            <ul class="pull-right top-right-icons">
                ...
                <li>
                    ...
                    // var_dump($_inbox_count);
                    ?>

                    <a href="#"></a><a href="<?php echo base_url() ?>inbox">Inbox<span class="badge badge-light sp-bd-light"><?php echo count($inbox_count); ?></span></a>
