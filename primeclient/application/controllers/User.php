...
public function update_image()
{
    ...
    $imageNamePath = FCPATH.'primeclientApi/assets/images/users/'.$imageName;
    file_put_contents($imageNamePath, $data);

    $this->load->library('image_lib');
    $config['image_library'] = 'gd2';
    $config['source_image'] = FCPATH."primeclientApi/assets/images/users/".$imageName_only;
    ...
    $imageName = FCPATH."primeclientApi/assets/images/users/".$imageName_only;
