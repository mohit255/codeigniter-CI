...
class admin_panel_model extends CI_Model
{
    ...
    {
        $query = $this->db->query("SELECT a.*,b.first_name, b.last_name,b.us_dollar_account,b.primary_peso_account FROM `buy_dollar_requests` as a,`clients` as b Where a.client_id = b.id AND request_status= 0  ORDER BY a.`request_time` DESC");
        $result = $query->result_array();
        return $result; 
    }
    public function sell_dollar()
    {
        $query = $this->db->query("SELECT a.*,b.first_name, b.last_name,b.us_dollar_account,b.primary_peso_account FROM `sell_dollar_requests` as a,`clients` as b Where a.client_id = b.id AND request_status= 0 ORDER BY a.`request_time` DESC");
        $result = $query->result_array();
        return $result; 
    }
    ...
    {
        $query = $this->db->query("SELECT a.*,b.branch_code,b.first_name, b.last_name,b.us_dollar_account,b.primary_peso_account FROM `time_deposit_request` as a,`clients` as b Where a.client_id = b.id AND request_status = 0 ORDER BY a.`request_time` DESC");
        $result = $query->result_array();
        return $result; 
    }
    ...
    {
        $query = $this->db->query("SELECT a.*,b.branch_code,b.first_name, b.last_name,b.us_dollar_account,b.primary_peso_account FROM `fixed_income_requests` as a,`clients` as b Where a.client_id = b.id AND request_status = 0 ORDER BY a.`request_time` DESC");
        $result = $query->result_array();
        return $result; 
    }
