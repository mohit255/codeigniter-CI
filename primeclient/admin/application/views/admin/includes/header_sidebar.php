            ...
            <div class="col-md-10 col-md-offset-1" style="text-align: center;">
               ...
               <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                 ...
                 // var_dump($this->db->last_query());
                  ...
                  ?>
                  <tr>
                     <td align="left" valign="top" style="text-align:center;"><strong><?php echo date('M d, Y h:m:s');?></strong></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                     <td align="left" valign="top" style="text-align:center;"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                           <tr>
                              ...
                              <td align="left" valign="top" style="text-align:center;"><?php echo $rate["fixed_income_rate_t-bills_1y"]; ?>%</td>
                           </tr>
                        </table></td>
