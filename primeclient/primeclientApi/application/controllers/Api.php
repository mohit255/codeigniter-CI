...
#####################################PrimeClient App Api Start##########################################
    ...
    public function get_branches()
  {
    ...
    public function client_login()
    {
       ...
       if ($data){
        $login_data = array('device_token' =>@$device_token);
...
Pls try again")); 
    ...
    public function get_notifications()
    {
       ...
       $data=$this->db->query("SELECT * FROM notification WHERE send_to IN ('".$client_id."','all') ORDER BY `send_at` DESC")->result_array();   
