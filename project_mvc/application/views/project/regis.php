<div class="container">
  <div class="">
    <?= form_open('user/regis',['class'=>'form-horizontal','method'=>'post']); ?>
    <fieldset>
      ...
      <div class="row">
        <div class="form-group col-lg-10">
          <label for="inputPassword" class="col-lg-2 control-label">Age</label>
          <div class="col-lg-10">
            <?php echo form_input(['name'=>'age','class'=>'form-control','placeholder'=>'Age']);?>
          </div>
        </div>
      </div>
      ...
      <div class="form-group">
        <div class="col-lg-10 col-lg-offset-2">
          ...
          <?php echo form_submit(['name'=>'sub','class'=>'btn btn-primary','value'=>'Submit']);?>
        </div>
      </div>
    </fieldset>
  </form>
