  ...
  <fieldset>
    ...
    <div class="row">
      <div class="form-group col-lg-10">
        ...
        <div class="col-lg-10">
          <?php echo form_input(['name'=>'img','type'=>'file','class'=>'form-control']);?>
        </div>
      </div>
  	</div>
    ...
    <div class="row">
      <div class="form-group col-lg-10">
        ...
        <div class="col-lg-10">
          <?php echo form_textarea(['name'=>'body','class'=>'form-control','rows'=>'5','placeholder'=>'Article Body','value'=>set_value('body')]);?>
        </div>
      </div>
      <div class="col-lg-10" align="right">
    ...
    <div class="form-group">
      <div class="col-lg-6 col-lg-offset-5">
        ...
        <?php echo form_submit(['name'=>'sub','class'=>'btn btn-primary','value'=>'Add Article']);?>
      </div>
    </div>
  </fieldset>
</form>
