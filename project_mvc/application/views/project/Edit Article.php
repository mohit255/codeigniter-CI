<div class="container">
  ...
  <?= form_open('admin/edit_article',['class'=>'form-horizontal']); ?>
  ...
  <fieldset>
    ...
    <div class="row">
      <div class="form-group col-lg-10">
        ...
        <div class="col-lg-10">
          <?php echo form_input(['name'=>'title','class'=>'form-control','placeholder'=>'Article Title','value'=>$article->title]);?>
        </div>
      </div>      
    ...
    <div class="row">
      <div class="form-group col-lg-10">
        ...
        <div class="col-lg-10">
          <?php echo form_textarea(['name'=>'body','class'=>'form-control','rows'=>'5','placeholder'=>'Article Body','value'=>$article->body]);?>
        </div>
      </div>
      <div class="col-lg-10" align="right">
